...
|   输入    |    显示     |    输入    |     显示     |   输入    |    显示     |    输入    |     显示     |
| :-------: | :---------: | :--------: | :----------: | :-------: | :---------: | :--------: | :----------: |
| \sim | $\sim$ | \emptyset`或`\varnothing | $\emptyset$或$\varnothing$ |           |             |            |              |
...
| \geqslant | $\geqslant$ | \leqslant | $\leqslant$ | \overset{def：}{=} | $\overset{def：}{=}$ |  |  |
...
|\bf|粗体|${\bf example 例子},\mathbf{ABCDEF}$|\mit|数学斜体|${\mit example}$|
|\sf|等线体|${\sf example S},\mathsf{SSSSSSS}$|\scr|手写体|${\scr example}$|
|\tt|打字机体|${\tt example例子 SSSS}  \tt{SSXXX}$|\cal|花体|$\cal{M,H,A,S, X}$|
|\frak|旧德式字体|${\frak example}$|\mathbb{A}|字体Blackboard Bold|$\mathbb{A,B,C,D,E,F,abcdef}$|
