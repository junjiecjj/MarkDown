...
hi IncSearch guifg=#33ff1c guibg=#3454ff guisp=#3454ff gui=bold ctermfg=10 ctermbg=13 cterm=bold
...
hi Typedef guifg=#ffa600 guibg=#2d2211 guisp=#2d2211 gui=NONE ctermfg=214 ctermbg=236 cterm=NONE
...
hi Conditional guifg=#ff7b7b guibg=#2d2222 guisp=#2d2222 gui=bold ctermfg=210 ctermbg=236 cterm=bold
hi StorageClass guifg=#ffa600 guibg=#2d2211 guisp=#2d2211 gui=NONE ctermfg=214 ctermbg=236 cterm=NONE
...
hi Label guifg=#ff7b7b guibg=#2d2222 guisp=#2d2222 gui=bold ctermfg=210 ctermbg=236 cterm=bold
...
hi Statement guifg=#ff7b7b guibg=#2d2222 guisp=#2d2222 gui=bold ctermfg=210 ctermbg=236 cterm=bold
...
hi Operator guifg=#ff7b7b guibg=#2d2222 guisp=#2d2222 gui=bold ctermfg=210 ctermbg=236 cterm=bold
hi CursorLine guifg=NONE guibg=#333333 guisp=#333333 gui=NONE ctermfg=NONE ctermbg=236 cterm=NONE
hi Question guifg=#00ffaa guibg=#113322 guisp=#113322 gui=bold ctermfg=49 ctermbg=22 cterm=bold
hi WarningMsg guifg=#ffa600 guibg=#000080 guisp=#000080 gui=NONE ctermfg=214 ctermbg=18 cterm=NONE
hi DiffDelete guifg=#9c9c9c guibg=#ee6699 guisp=#ee6699 gui=NONE ctermfg=247 ctermbg=204 cterm=NONE
hi ModeMsg guifg=#ffff5a guibg=#222211 guisp=#222211 gui=bold ctermfg=227 ctermbg=235 cterm=bold
...
hi Exception guifg=#ff7b7b guibg=#2d2222 guisp=#2d2222 gui=bold ctermfg=210 ctermbg=236 cterm=bold
hi Keyword guifg=#ff7b7b guibg=#2d2222 guisp=#2d2222 gui=bold ctermfg=210 ctermbg=236 cterm=bold
hi Type guifg=#ffa600 guibg=#2d2211 guisp=#2d2211 gui=NONE ctermfg=214 ctermbg=236 cterm=NONE
...
hi SpecialKey guifg=#00ffea guibg=#22302D guisp=#22302D gui=NONE ctermfg=50 ctermbg=236 cterm=NONE
...
hi Repeat guifg=#ff7b7b guibg=#2d2222 guisp=#2d2222 gui=bold ctermfg=210 ctermbg=236 cterm=bold
hi Directory guifg=#ff99ff guibg=NONE guisp=NONE gui=NONE ctermfg=213 ctermbg=NONE cterm=NONE
hi Structure guifg=#ffa600 guibg=#2d2211 guisp=#2d2211 gui=NONE ctermfg=214 ctermbg=236 cterm=NONE
